...
Customer Churn Analysis for an Online Food Delivery Platform using MySQL. Designed a 3NF relational database and performed SQL-based analysis to identify customer behavior and churn patterns.

Project Overview
This project focuses on analyzing customer churn for an online food delivery platform using MySQL. A normalized relational database was designed to manage customers, restaurants, orders, deliveries, payments, feedback, and churn information. SQL queries were used to analyze customer behavior, identify churn patterns, and generate business insights.
